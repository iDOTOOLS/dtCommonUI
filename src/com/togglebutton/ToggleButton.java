...
import com.dotools.commonui.R;
import com.dotools.utils.UiUtils;
import com.togglebutton.rebound.SimpleSpringListener;
import com.togglebutton.rebound.Spring;
import com.togglebutton.rebound.SpringConfig;
import com.togglebutton.rebound.SpringSystem;
import com.togglebutton.rebound.SpringUtil;
...
public class ToggleButton extends View{
    ...
    /** 开启颜色*/
    private int onColor = Color.parseColor("#6269f5");
    /** 关闭颜色*/
    private int offColor = Color.parseColor("#a8a8a8");
    /** 灰色带颜色*/
    private int offBorderColor = Color.parseColor("#848484");
    /** 手柄颜色*/
    ...
    /** 边框大小*/
    private int borderWidth = UiUtils.dipToPx(1) >= 3 ? 2 : 1;

    private int borderValidWidth = 4;
	...
	public void onAttachedToWindow() {UiUtils.dipToPx(1);
	...
	public void toggle(boolean animate) {
		...
		if(listener != null){
		    postDelayed(new Runnable() {
                @Override
                public void run() {
                    listener.onToggle(ToggleButton.this,toggleOn);
                }
            }, 300);
		}
	}
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		validWidth = getWidth() - borderValidWidth * 2;
		int height = getHeight();
		
		radius = Math.min(validWidth, height) * 0.5f;
		centerY = radius;
		startX = radius ;
		endX = validWidth - radius;
	...
	public void draw(Canvas canvas) {
		canvas.translate(borderValidWidth, 0);
		rect.set(0, 0, validWidth, getHeight());
