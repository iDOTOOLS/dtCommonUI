...
public class AnimatorInflater {
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                TypedArray a = c.obtainStyledAttributes(attrs,
                        /*com.android.internal.Res.styleable.*/AnimatorSet);

                TypedValue orderingValue = new TypedValue();
                a.getValue(/*com.android.internal.Res.styleable.*/AnimatorSet_ordering, orderingValue);
    ...
    private static ObjectAnimator loadObjectAnimator(Context context, AttributeSet attrs)
        ...
        TypedArray a =
                context.obtainStyledAttributes(attrs, /*com.android.internal.Res.styleable.*/PropertyAnimator);

        String propertyName = a.getString(/*com.android.internal.Res.styleable.*/PropertyAnimator_propertyName);
    ...
    private static ValueAnimator loadAnimator(Context context, AttributeSet attrs, ValueAnimator anim)
        ...
        TypedArray a =
                context.obtainStyledAttributes(attrs, /*com.android.internal.Res.styleable.*/Animator);

        long duration = a.getInt(/*com.android.internal.Res.styleable.*/Animator_duration, 0);

        long startDelay = a.getInt(/*com.android.internal.Res.styleable.*/Animator_startOffset, 0);

        int valueType = a.getInt(/*com.android.internal.Res.styleable.*/Animator_valueType,
                VALUE_TYPE_FLOAT);
        ...
        int valueFromIndex = /*com.android.internal.Res.styleable.*/Animator_valueFrom;
        int valueToIndex = /*com.android.internal.Res.styleable.*/Animator_valueTo;
        ...
        if (a.hasValue(/*com.android.internal.Res.styleable.*/Animator_repeatCount)) {
            anim.setRepeatCount(
                    a.getInt(/*com.android.internal.Res.styleable.*/Animator_repeatCount, 0));
        }
        if (a.hasValue(/*com.android.internal.Res.styleable.*/Animator_repeatMode)) {
            anim.setRepeatMode(
                    a.getInt(/*com.android.internal.Res.styleable.*/Animator_repeatMode,
        ...
        final int resID =
                a.getResourceId(/*com.android.internal.Res.styleable.*/Animator_interpolator, 0);
        if (resID > 0) {
